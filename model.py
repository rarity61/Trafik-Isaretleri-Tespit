...
print("Tespit Edilen Toplam Sınıflar:", len(myList))
...
######### HER VERİ KÜMESİNE İLİŞKİN ETİKET SAYISI İLE GÖRÜNTÜ SAYISININ EŞLEŞTİRİLMESİ ############
print("Data Shapes")
print("Train", end="")
...
########## TÜM SINIFLARIN BAZI ÖRNEK GÖRÜNTÜLERİNİ GÖRÜNTÜLEYİN ###############
num_of_samples = []
cols = 5
...
############# HER KATEGORİ İÇİN NUMUNE SAYISINI GÖSTEREN BİR ÇUBUK ŞEMASI######################
